"""Implement a function called sort students that takes a list of student objects as input and sorts the list based on their CGPA (cumulative grade point avarage) in descending order.
...
students = [
    student("narmatha", "A001", 9.9),
    student("tom", "A002", 9.3),
    student("jerry", "A003", 7.3),
]
